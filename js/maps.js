let maps = [{
  ...
  draw: (player) => {
    ...
    if (maps[2].count % 300 === 0) {
      maps[2].fireBalls.push(new FireBall(3.5 * tile1.size, canvas.height - 2 * tile1.size, 0, - tile1.size / 7.5, tile1.size / 2, 0.1));
      maps[2].fireBalls.push(new FireBall(8.5 * tile1.size, canvas.height - 2 * tile1.size, 0, - tile1.size / 7.5, tile1.size / 2, 0.1));
      maps[2].fireBalls.push(new FireBall(13.5 * tile1.size, canvas.height - 2 * tile1.size, 0, - tile1.size / 7.5, tile1.size / 2, 0.1));
      maps[2].fireBalls.push(new FireBall(18.5 * tile1.size, canvas.height - 2 * tile1.size, 0, - tile1.size / 7.5, tile1.size / 2, 0.1));
      maps[2].fireBalls.push(new FireBall(22.5 * tile1.size, canvas.height - 2 * tile1.size, 0, - tile1.size / 7.5, tile1.size / 2, 0.1));
    }
